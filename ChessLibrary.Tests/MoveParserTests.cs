...
namespace ChessLibrary.Tests
{
    ...
    public class MoveParserTests
    {
        ...
        [TestCase("1n4k1/8/5n2/8/8/8/8/6K1", "b8,d7", '\0', AttackState.None, ExpectedResult = "Nbd7", Description = "Knight move disambiguate defaults to file when none explicitly required")]
